...
// @namespace    unrival
// @version      1.40
// @description  ▶▶▶上次更新：2022.10.07◀◀◀⚠⚠⚠最近超星更新频繁，强烈建议使用近期更新的最新版脚本，防止出现异常⚠⚠⚠【✅独家题库实时更新】【💻可最小化💻】🆒支持超星视频、文档、答题、自定义正确率、掉线自动登录🤘取消视频文件加载，多开也不占用网速，放心追剧🍊自定义答题正确率，提高学习效率🍆每日功能测试，在发现问题前就解决问题，防清进度，无不良记录 
// @author       unrival
// @run-at       document-end
...
// ==/UserScript==
(() => {
	var token = 'gsYmimOpGMCIOtEM', //关注微信公众号：一之哥哥，发送 “token” 领取你的token，填写在两个单引号中间并保存，可以提高答题并发数量。
		jumpType = 0, // 0:智能模式，1:遍历模式，2:不跳转，如果智能模式出现无限跳转/不跳转情况，请切换为遍历模式
		disableMonitor = 1, // 0:无操作，1:解除多端学习监控，开启此功能后可以多端学习，不会被强制下线。
		accuracy = 80, //章节测试正确率百分比，在答题正确率在规定之上并且允许自动提交时才会提交答案
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div>
                                ...
                                &ensp;
                                <a id='updateRateButton' class="btn btn-default">修改倍速</a>
                                &nbsp;|&nbsp;
